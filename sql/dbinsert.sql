...
-- 2. load data
LOAD DATA INFILE 'C:/xampp/team05/data/olympic_hosts.csv'
...
LOAD DATA INFILE 'C:/xampp/team05/data/olympic_medals.csv'
...
LOAD DATA INFILE 'C:/xampp/team05/data/olympic_results.csv'
